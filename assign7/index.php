  ...
  <div class="container py-3">
    ...
    <div class="row m-3">
      <div class="col-12 text-center">
        <p>AJAX Addition: Click on the table headers to organize by ascending or descending</p>
      </div>
    </div>

    <div class="row m-3">
      <div class="col table-responsive" id="movieTable">
        <table class="table table-hover border">
          <thead class="table-primary">
            <tr>
              <th scope="col"><a class="column_sort" id="id" data-order="desc" href="#">ID</a></th>
              <th scope="col"><a class="column_sort" id="title" data-order="desc" href="#">Title</a></th>
              <th scope="col"><a class="column_sort" id="genre" data-order="desc" href="#">Genre</a></th>
              <th scope="col"><a class="column_sort" id="year" data-order="desc" href="#">Year</a></th>
              <th scope="col"><a class="column_sort" id="link" data-order="desc" href="#">iMDb</a></th>
              <th scope="col"><a class="column_sort" id="runtime" data-order="desc" href="#">Runtime(min)</a></th>
            </tr>
          </thead>
          <tbody>
            <?php
            ...
            ?>
              <tr>
                ...
                <td><a class="web" target="_blank" href="<?php echo $row["link"]; ?>">Link</a></td>
